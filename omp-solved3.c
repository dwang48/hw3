...
#include <stdlib.h>
#define N     50
//The intention of the original code is to print out message "Thread tid done and synchronized" for all threads.
//Without omp barrier, the following printf code will work fine. Otherwise there will only be one print statement. 
